...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'user.update': {
    ...
    key: 'employee-updated-personal-data',
    tenantPath: ['company', 'user'],
    userPath: [],
  },
  'payroll.update': {
    roles: ['system-administrator'],
    key: 'payroll-staff-updated-payroll',
    tenantPath: ['company', 'user', 'payroll'],
    userPath: [],
  },
  'vacation.create': {
    roles: ['system-administrator'],
    key: 'employee-submitted-vacation-request',
    tenantPath: ['company', 'user', 'vacation'],
    userPath: [],
  },
  'performance_evaluation.update': {
    roles: ['system-administrator'],
    key: 'team-lead-updated-performance-evaluation',
...
const tenantRoles: string[] = ['system-administrator'];
